...
namespace BiodataTest.Utility
{
    public class CMail
    {
        ...
        ///// </summary>
        //public string ComposedDate { get; set; }
        ///// <summary>
